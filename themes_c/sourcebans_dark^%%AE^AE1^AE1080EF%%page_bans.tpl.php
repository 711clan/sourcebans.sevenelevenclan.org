<?php /* Smarty version 2.6.20, created on 2011-03-26 05:05:38
         compiled from page_bans.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'help_icon', 'page_bans.tpl', 5, false),array('function', 'sb_button', 'page_bans.tpl', 23, false),array('modifier', 'htmlspecialchars', 'page_bans.tpl', 60, false),array('modifier', 'escape', 'page_bans.tpl', 90, false),)), $this); ?>
...
?>
			...
			<?php if ($this->_tpl_vars['ban']['server'] != 'Web Ban'): ?>
...
"></td>
        ...
        <td height="16" class="listtable_1">
          ...
          <?php else: ?>
            <?php echo ((is_array($_tmp=$this->_tpl_vars['ban']['player'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
