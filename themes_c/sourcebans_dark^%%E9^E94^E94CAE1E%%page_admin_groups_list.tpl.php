<?php /* Smarty version 2.6.20, created on 2011-08-07 04:50:36
...
" class="opener tbl_out" onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'">
				<td style="border-bottom: solid 1px #ccc" height='16'><?php echo $this->_tpl_vars['group']['name']; ?>
</td>
		      	<td style="border-bottom: solid 1px #ccc" height='16'><?php echo $this->_tpl_vars['web_admins'][($this->_foreach['web_group']['iteration']-1)]; ?>
</td>
...
" class="opener tbl_out" onmouseout="this.className='tbl_out'" onmouseover="this.setProperty('class', 'tbl_hover')">
			<td style="border-bottom: solid 1px #ccc" height='16'><?php echo $this->_tpl_vars['group']['name']; ?>
	      	...
	      	<td style="border-bottom: solid 1px #ccc" height='16'><?php echo $this->_tpl_vars['server_admins'][($this->_foreach['server_admin_group']['iteration']-1)]; ?>
</td>
	        <td style="border-bottom: solid 1px #ccc" height='16'> 
				<?php if ($this->_tpl_vars['permission_editgroup']): ?>
...
" class="opener tbl_out" onmouseout="this.className='tbl_out'" onmouseover="this.setProperty('class', 'tbl_hover')">
	            <td style="border-bottom: solid 1px #ccc" height='16'><?php echo $this->_tpl_vars['group']['name']; ?>
	      		...
	      		<td style="border-bottom: solid 1px #ccc" height='16'><?php echo $this->_tpl_vars['server_counts'][($this->_foreach['server_group']['iteration']-1)]; ?>
</td>
	            <td style="border-bottom: solid 1px #ccc" height='16'>   
	            <?php if ($this->_tpl_vars['permission_editgroup']): ?>
