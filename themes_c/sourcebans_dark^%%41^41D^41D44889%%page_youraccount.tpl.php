<?php /* Smarty version 2.6.20, created on 2011-04-02 20:59:09
...
, $('current').value);" class="submit-fields" id="current" name="current" />
      </div>
...
, $('scurrent').value);" class="submit-fields" id="scurrent" name="scurrent" />
      </div>
